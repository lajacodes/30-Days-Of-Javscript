...
console.log(myName.substr(3, 18));
...
console.log(myTake.search("because"));
...
let _myTake = "30 Days Of ";
console.log(_myTake.concat("JavaScript"));
...
const page = "javaScript".split("");
console.log(page[Math.round(Math.random() * page.length)]);
...
let names = "mujib laja muhammed adnan muzzamail".split(" ");
const generate = names[Math.round(Math.random() * names.length)];
