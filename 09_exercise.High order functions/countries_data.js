...
console.log(categories);
 ...
 function countryLetters () {
   ...
   const categorie = letters.map((letter) => {
...
/*for (let i = 2; i <= 10; i++) {
 ...
 console.log(countries.sort((a, b) => b.population - a.population).slice(0, 11).map(country => ({ name: country.name, population: country.population })))
...
console.log(countries.sort((a,b) =>a.capital - b.capital).slice(0, 10))


const mostPopulationCountries = (countries, count = 10) => {
    countries
    .sort((a, b) => b.population - a.population)
    .slice(0, count) 
}
console.log(mostPopulationCountries(countries, 10));

const mostPopulationLanguages = (countries, count = 10) => {
    countries
    .sort((a, b) => b.languages - a.languages)
    .slice(0, count) 
}
console.log(mostPopulationLanguages(countries, 10));
